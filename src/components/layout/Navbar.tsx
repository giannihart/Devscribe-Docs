    ...
    <header className="w-full h-16 border-b border-devscribe-border flex items-center px-6 bg-devscribe-dark-gray z-50 fixed top-0 left-0 right-0">
      <div className="flex items-center justify-between w-full">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to="/api-marketplace" className="bg-white text-black font-medium px-4 py-1.5 rounded-full text-sm flex items-center gap-2 hover:bg-white/90 transition-colors">
            APIs
