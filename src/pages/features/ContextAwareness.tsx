      ...
      <div className="mt-8 space-y-6">
        <div className="bg-codium-hover-bg border border-codium-border rounded-lg p-6">
          <div className="flex items-start gap-4">
            <div className="p-3 bg-codium-teal/10 rounded-lg">
              <Eye size={24} className="text-codium-teal" />
            </div>
            <div>
              <h3 className="text-xl font-semibold mb-2">Deep Code Understanding</h3>
              <p className="text-codium-text-secondary">
                Codium's context awareness feature allows the AI to understand your entire codebase - from project structure and dependencies 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-codium-dark-gray border border-codium-border rounded-lg p-6">
            <div className="text-center mb-4">
              <div className="inline-flex items-center justify-center p-3 bg-codium-hover-bg rounded-full mb-3">
                <Folder size={24} className="text-codium-teal" />
              </div>
              <h3 className="text-lg font-semibold">Code Indexing</h3>
            </div>
            <p className="text-sm text-codium-text-secondary text-center">
        ...
        <div className="space-y-4">
          <div className="bg-codium-hover-bg border border-codium-border rounded-lg p-5">
            ...
            <div className="mt-4 bg-codium-dark-gray p-3 rounded-md">
              <p className="text-xs text-codium-text-secondary">
                If your project uses React with function components and hooks, Codium will suggest new components following the same pattern rather than class-based components.
              </p>
            </div>
          </div>
          ...
          <div className="bg-codium-hover-bg border border-codium-border rounded-lg p-5">
            ...
            <div className="mt-4 bg-codium-dark-gray p-3 rounded-md">
              <p className="text-xs text-codium-text-secondary">
                When you use a component like <code className="text-codium-teal">Button</code> from your project's UI library, Codium will automatically add the correct import from your component library.
              </p>
            </div>
          </div>
          ...
          <div className="bg-codium-hover-bg border border-codium-border rounded-lg p-5">
            ...
            <div className="mt-4 bg-codium-dark-gray p-3 rounded-md">
              <p className="text-xs text-codium-text-secondary">
                Ask "Where is the authentication logic used?" and Codium will show you all the files and components that interact with your auth system.
              </p>
            </div>
          </div>
          ...
          <div className="bg-codium-hover-bg border border-codium-border rounded-lg p-5">
            ...
            <div className="mt-4 bg-codium-dark-gray p-3 rounded-md">
              <p className="text-xs text-codium-text-secondary">
                Codium can detect that you're using an outdated API method from another file in your project, or that a state update may cause an infinite render loop.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-codium-dark-gray border border-codium-border rounded-lg p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <pre className="text-xs font-mono bg-codium-hover-bg p-3 rounded-md overflow-x-auto">
...
// Form validation uses your validation.ts utilities`}
          ...
          <div className="space-y-4">
            <div className="bg-codium-hover-bg p-4 rounded-md">
              ...
              <p className="text-sm text-codium-text-secondary">"Create a registration form"</p>
            </div>
...
export default Registration;`}
          ...
          <p className="text-xs text-codium-text-secondary mt-4">
            Notice how Codium generated code that uses your existing components, hooks, and validation utilities in a way that matches your project patterns.
          </p>
        </div>
      </div>
    </div>
