  ...
  return (
    <div className="px-12 py-10 max-w-4xl">
      <PageHeading 
        ...
        description="Learn about Cascade, Codium's agentic AI assistant that understands your codebase and helps solve complex problems."
      />
        ...
        <section>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-codium-card-bg border border-codium-border rounded-xl p-6">
              <div className="mb-4">
                <Layers size={24} className="text-codium-teal" />
              </div>
            ...
            <div className="bg-codium-card-bg border border-codium-border rounded-xl p-6">
              <div className="mb-4">
                <RefreshCw size={24} className="text-codium-teal" />
              </div>
          ...
          <div className="space-y-6">
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-codium-text-secondary mb-3">
                  Access Cascade by clicking the chat icon in the sidebar or using the keyboard shortcut <kbd className="px-2 py-0.5 bg-codium-hover-bg rounded text-xs">Ctrl</kbd> + <kbd className="px-2 py-0.5 bg-codium-hover-bg rounded text-xs">Shift</kbd> + <kbd className="px-2 py-0.5 bg-codium-hover-bg rounded text-xs">C</kbd>.
                </p>
                <div className="bg-codium-card-bg border border-codium-border rounded-xl p-4 flex items-center gap-4">
                  <MessageSquare size={32} className="text-codium-teal" />
                  <div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <div className="bg-codium-card-bg border border-codium-border rounded-xl overflow-hidden">
                  <div className="bg-codium-hover-bg p-3 border-b border-codium-border">
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <div className="bg-codium-card-bg border border-codium-border rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Code size={16} className="text-codium-teal" />
                    <span className="text-sm font-medium">Pro tip:</span>
                  </div>
                  <p className="text-sm text-codium-text-secondary">
                    You can select code in your editor and send it to Cascade by right-clicking and selecting "Ask Cascade about selected code" or using the shortcut <kbd className="px-2 py-0.5 bg-codium-hover-bg rounded text-xs">Alt</kbd> + <kbd className="px-2 py-0.5 bg-codium-hover-bg rounded text-xs">C</kbd>.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="bg-gradient-to-r from-codium-teal/20 to-transparent border border-codium-border rounded-xl p-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="/windsurf/models" className="flex-1 bg-black/20 rounded-lg p-4 hover:bg-black/30 transition-colors">
              ...
              <p className="text-sm text-codium-text-secondary">Learn about the different AI models available in Windsurf.</p>
            </a>
            <a href="/windsurf/usage" className="flex-1 bg-black/20 rounded-lg p-4 hover:bg-black/30 transition-colors">
              ...
              <p className="text-sm text-codium-text-secondary">Discover best practices for using Windsurf in your workflow.</p>
            </a>
            <a href="/windsurf/advanced" className="flex-1 bg-black/20 rounded-lg p-4 hover:bg-black/30 transition-colors">
              ...
              <p className="text-sm text-codium-text-secondary">Explore advanced capabilities for power users.</p>
            </a>
          </div>
        </section>
      </div>
