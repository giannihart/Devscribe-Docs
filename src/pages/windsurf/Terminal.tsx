      ...
      <div className="mt-8 space-y-6">
        <div className="bg-codium-hover-bg border border-codium-border rounded-lg p-6">
          <div className="flex items-start gap-4">
            <div className="p-3 bg-codium-teal/10 rounded-lg">
              <TerminalIcon size={24} className="text-codium-teal" />
            </div>
            <div>
        ...
        <div className="grid gap-4">
          <div className="bg-codium-dark-gray border border-codium-border rounded-lg p-4">
            <code className="text-codium-teal">windsurf ask "How do I implement authentication in Next.js?"</code>
            <p className="text-sm text-codium-text-secondary mt-2">Ask Windsurf AI a question directly from your terminal</p>
          </div>
          
          <div className="bg-codium-dark-gray border border-codium-border rounded-lg p-4">
            <code className="text-codium-teal">windsurf explain ./path/to/file.js</code>
            <p className="text-sm text-codium-text-secondary mt-2">Get an explanation of what a file or code snippet does</p>
          </div>
          
          <div className="bg-codium-dark-gray border border-codium-border rounded-lg p-4">
            <code className="text-codium-teal">windsurf refactor ./path/to/file.js --pattern="singleton"</code>
            <p className="text-sm text-codium-text-secondary mt-2">Refactor a file to implement a specific design pattern</p>
          </div>
        </div>
        
        <h2 className="text-2xl font-semibold mt-8 mb-4">Terminal Configuration</h2>
        <p className="text-codium-text-secondary mb-4">
          You can customize the terminal integration by creating a <code className="bg-codium-dark-gray px-1.5 py-0.5 rounded text-sm">.windsurfrc</code> file in your home directory or project root.
        </p>
        
        <div className="bg-codium-dark-gray border border-codium-border rounded-lg p-4 mb-8">
          <pre className="text-codium-text-secondary">
{`{
  "model": "cascade-pro",
  "logLevel": "info",
  "maxTokens": 4096,
